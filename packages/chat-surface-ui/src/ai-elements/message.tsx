...
export const MessageResponse = memo(
  ({ className, ...props }: MessageResponseProps) => (
    <Streamdown
      ...
      // 关闭 Streamdown 默认的链接安全确认（linkSafety.enabled 默认为 true）：
      // 默认会把 markdown 链接渲染成 <button>，点击弹「是否跳转」确认 modal，
      // 报告/图表链接（agent 工具生成的内部链接）点击没有直接跳转，体验是
      // 「链接不可点」。渲染为原生 <a href> 直接可点（sanitize 白名单仍在，
