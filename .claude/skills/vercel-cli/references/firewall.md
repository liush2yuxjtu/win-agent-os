...
vercel firewall ip-blocks block 127.0.0.1/24 --hostname example.com --yes  # block CIDR on specific host
...
vercel firewall system-bypass add 127.0.0.1 --yes                       # bypass for an IP
vercel firewall system-bypass add 127.0.0.1/24 --yes                    # bypass for a CIDR range
vercel firewall system-bypass add 127.0.0.1 --domain example.com --yes  # bypass scoped to a domain
vercel firewall system-bypass add 127.0.0.1 --domain "*.example.com" --yes  # bypass with wildcard domain
vercel firewall system-bypass add 127.0.0.1 --notes "Office IP" --yes   # bypass with a note
vercel firewall system-bypass remove 127.0.0.1 --yes                    # remove bypass
```
